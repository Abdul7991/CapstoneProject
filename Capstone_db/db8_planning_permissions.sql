...
--
-- Dumping data for table `planning_permissions`
--

LOCK TABLES `planning_permissions` WRITE;
/*!40000 ALTER TABLE `planning_permissions` DISABLE KEYS */;
/*!40000 ALTER TABLE `planning_permissions` ENABLE KEYS */;
UNLOCK TABLES;
